8.3.1
- Обновлена библиотека mpdf до 8.3.1
- Исправлена ошибка связанная с `psr/http-message` для совместимости с Joomla 6
- Закрыта уязвимость `CVE-2026-45802` в пакете `setasign/fpdi`
